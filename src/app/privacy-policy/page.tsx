      ...
      <main>
        ...
        <section className="py-16 bg-earney-surface">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="p-8 rounded-2xl border border-earney-purple/20 bg-earney-purple/5 mb-10">
              <p className="text-sm text-earney-purple font-mono">
            ...
            <div className="flex flex-col gap-8 text-sm text-muted-foreground leading-relaxed">
              {[
                ...
                { title: '6. Your Rights', body: 'You have the right to access, correct, or delete your personal data. To exercise these rights, please contact us at contact@earney.in.' },
                { title: '7. Contact Us', body: 'For any privacy-related questions or concerns, please contact us at contact@earney.in or call +91 99418 75131.' },
              ].map(({ title, body }) => (
